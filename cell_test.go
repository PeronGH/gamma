...
func TestStyleDiff(t *testing.T) {
	...
	tests := []struct {
		...
		// Underline color tests
		{
			...
			from: &Style{UnderlineColor: red, Underline: UnderlineSingle},
			to:   &Style{UnderlineColor: blue, Underline: UnderlineSingle},
			want: "\x1b[58;2;0;0;255m",
		},
		{
			name: "add underline color",
			from: &Style{Underline: UnderlineSingle},
			to:   &Style{UnderlineColor: green, Underline: UnderlineSingle},
			want: "\x1b[58;2;0;255;0m",
		},
		{
			name: "remove underline color",
			from: &Style{UnderlineColor: green, Underline: UnderlineSingle},
			to:   &Style{Underline: UnderlineSingle},
			want: "\x1b[59m",
		},
		{
		...
		},
		{
			...
			from: &Style{},
			to:   &Style{Underline: UnderlineDouble},
			want: "\x1b[4:2m",
		},
		{
			name: "add curly underline",
			from: &Style{},
			to:   &Style{Underline: UnderlineCurly},
			want: "\x1b[4:3m",
		},
		{
			name: "add dotted underline",
			from: &Style{},
			to:   &Style{Underline: UnderlineDotted},
			want: "\x1b[4:4m",
		},
		{
			name: "add dashed underline",
			from: &Style{},
			to:   &Style{Underline: UnderlineDashed},
			want: "\x1b[4:5m",
		},
		{
		...
		},
		{
			...
			from: &Style{Underline: UnderlineDouble},
			to:   &Style{Underline: UnderlineCurly},
			want: "\x1b[4:3m",
		},
		{
		...
		// Multiple attribute combinations
		{
			...
			from: &Style{},
			to:   &Style{Attrs: AttrBold | AttrItalic, Underline: UnderlineSingle},
			want: "\x1b[1;3;4m",
		},
		{
